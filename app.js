...
async function handleChatCompletion(req, res) {
  ...
  try {
    ...
    let proofToken = generateProofToken(
      ...
      userAgent // Make sure userAgent is defined somewhere in your code
    );
    const body = {
      action: "next",
      ...
      parent_message_id: randomUUID(), // Ensure randomUUID function is available
      model: "text-davinci-002-render-sha",
      timezone_offset_min: -180,
      suggestions: [],
      history_and_training_disabled: true,
      conversation_mode: { kind: "primary_assistant" },
      websocket_request_id: randomUUID(), // Ensure randomUUID function is available
    };
    let promptTokens = 0;
